    ...
    const handleUpdateState = async (state) => {
        if (state) {
            try {
                ...
                await axios.put(
                    "http://localhost:8080/api/product-variant/on",
                ...
                setDisabledInputState(false);
                swtoast.error({
                    text: "Xảy ra lỗi khi mở bán vui lòng thử lại!",
                });
            }
        } else {
            try {
                setDisabledInputState(true);
                await axios.put(
                    "http://localhost:8080/api/product-variant/off",
                    { product_variant_ids: [props.product_variant_id] }
                );
                setDisabledInputState(false);
                props.refreshProductVariantTable();
                ...
                setDisabledInputState(false);
                swtoast.error({
                    text: "Xảy ra lỗi khi tắt sản phẩm vui lòng thử lại!",
                });
            }
        }
    };
                    ...
                    <tr className="w-100">
                        ...
                        >
                            ...
                            >
                                ...
                                <p
                                    className="name d-flex flex-column justify-content-start align-items-start"
                                    style={{
                                        margin: "0 20px",
                                    }}
                                >
